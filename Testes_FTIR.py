...
class TestFTIRApp(unittest.TestCase):
    ...
    def teste_coleta_data_mensagem(self):
    ...
    def teste_coleta_data_antes_2024_mensagem(self):
    ...
    def teste_coleta_data_formato_incorreto_mensagem(self):
    ...
    def teste_coleta_data_sem_insercao_mensagem(self):
    ...
    def teste_coleta_R_mensagem(self):
    ...
    def teste_coleta_R_sem_insercao_mensagem(self):
    ...
    def teste_coleta_R_negativo_mensagem(self):
    ...
    def teste_coleta_R_formato_incorreto_mensagem(self):
    ...
    def teste_delecao_R_sem_coleta_mensagem(self):
        self.app.deletar_R()
        self.assertEqual(self.app.R, 0)
        self.assertEqual(self.mensagem_erro(), "R ainda não coletado.")

    # Teste de deleção de R já coletado
    def teste_delecao_R_ja_coletado_mensagem(self):
        self.app.R = 1.0
        self.app.deletar_R()
        self.assertEqual(self.app.R, 0)
