...
class TestViscosidadeApp(unittest.TestCase):
    ...
    def teste_geracao_marcacoes_temporais(self):
        self.app.passo = 3.0
        self.app.temp_tot = 10.0
        self.app.gerar_marc_temp()
        self.assertEqual(self.app.tempo_medidas, [0.0, 3.0, 6.0, 9.0])
        self.assertEqual(self.mensagem_erro(), "O intervalo de 10.0 min foi dividido em 4 marcações. A primeira marcação é de 0.0 min e a última é de 9.0 min.")
    ...
    def teste_coleta_dados_viscosidade_laboratorio(self):
        ...
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 14000.0 cP para a escala laboratorial relativo à marcação temporal 0.0 min foi coletado.")
    ...
    def teste_coleta_dados_viscosidade_nao_satisfaz_sup_laboratorio(self):
        ...
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 41000.0 cP, que não satisfaz os critérios de aceite para a escala laboratorial, relativo à marcação temporal 20.0 min foi coletado.")
    ...
    def teste_coleta_dados_viscosidade__nao_satisfaz_inf_laboratorio(self):
        ...
        self.assertEqual(self.app.contador_lab, 2)
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 4000.0 cP, que não satisfaz os critérios de aceite para a escala laboratorial, relativo à marcação temporal 20.0 min foi coletado.")
    ...
    def teste_coleta_dados_viscosidade_processo(self):
        ...
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 14000.0 cP para a escala processual relativo à marcação temporal 0.0 min foi coletado.")
    ...
    def teste_coleta_dados_viscosidade_nao_satisfaz_sup_processo(self):
        ...
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 41000.0 cP, que não satisfaz os critérios de aceite para a escala processual, relativo à marcação temporal 20.0 min foi coletado.")
    ...
    def teste_coleta_dados_viscosidade__nao_satisfaz_inf_processo(self):
        ...
        self.assertEqual(self.app.contador_proc, 2)
        self.assertEqual(self.mensagem_erro(), "O valor de viscosidade 4000.0 cP, que não satisfaz os critérios de aceite para a escala processual, relativo à marcação temporal 20.0 min foi coletado.")
